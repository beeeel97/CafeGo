...
header("Content-Type: application/json");
  ...
  $actualizacion = mysqli_query($conexion, "UPDATE cafeterias SET NombreCafeteria = '" . $params->NombreCafeteria . "',PropietarioCafeteria = '" . $params->PropietarioCafeteria . "', DireccionCafeteria = '" . $params->DireccionCafeteria . "' WHERE IDCafeteria = '" . $params->IDCafeteria . "'");
